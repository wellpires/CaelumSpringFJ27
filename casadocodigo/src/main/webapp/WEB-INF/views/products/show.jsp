...
<link rel="canonical" href="http://www.casadocodigo.com.br/" />
	...
	<header id="layout-header">
		<div class="clearfix container">
			...
			<div id="header-content">
				<nav id="main-nav">
					<ul class="clearfix">
						<li><a href="${shoppingCartUrl}" rel="nofollow">Seu
								carrinho (${shoppingCart.quantity})</a></li>
		...
		<ul class="container">
			...
			<li class="category"><a
				href="/collections/livros-desenvolvimento-web"> <fmt:message
						key="navigation.category.web" /></a></li>
			<li class="category"><a href="/collections/outros"> <fmt:message
						key="navigation.category.others" /></a></li>
		</ul>
	</nav>
	...
	<article id="${product.title}" itemscope
		...
		<header id="product-highlight" class="clearfix">
			<div id="product-overview" class="container">
				...
				<p itemprop="description" class="book-description">
					${product.description}<br /> Veja o <a
		...
		<section class="buy-options clearfix">
			<form:form servletRelativeAction="${shoppingCartUrl}" method="post"
				cssClass="container">
